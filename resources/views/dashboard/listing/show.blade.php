...
@section('main')
    ...
    <h2>Preview</h2>
    <a class="btn btn-primary me-2" href="/dashboard/lists/"> <span data-feather="arrow-left"></span> Back to all job lists</a>
    ...
    <article class="border shadow col-md-8 mt-3 mb-5 p-3">
        ...
        <button class="mb-3 btn btn-primary">Apply Job</button>
    </article>
@endsection
