...
@section('container')
    ...
    <section>
        <div class="d-md-flex justify-content-evenly flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="bg-primary my-3 me-md-3 pt-3 px-3 shadow pt-md-5 px-md-5 text-center text-white overflow-hidden">
                <div class="my-3 py-3">
                ...
                <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 200px; border-radius: 21px 21px 0 0;">
                    <a href="/jobs" class="btn btn-primary px-5 py-3" style="position:relative; top:40%;">Search a job</a>
                </div>
            </div>
            <div class="bg-light my-3  me-md-3 pt-3 px-3 shadow pt-md-5 px-md-5 text-center overflow-hidden">
                ...
                <div class="bg-primary shadow-sm mx-auto" style="width: 80%; height: 200px; border-radius: 21px 21px 0 0;">
